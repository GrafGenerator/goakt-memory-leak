...
const file_messages_proto_rawDesc = "" +
	"\n" +
	"\x0emessages.proto\x12\x05proto\"\x1e\n" +
	"\bHelloMsg\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04textBw\n" +
	"\tcom.protoB\rMessagesProtoH\x02P\x01Z%goakt_memory_leak_1/internal/messages\xa2\x02\x03PXX\xaa\x02\x05Proto\xca\x02\x05Proto\xe2\x02\x11Proto\\GPBMetadata\xea\x02\x05Protob\x06proto3"
